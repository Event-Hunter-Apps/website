    ...
    <div class="container">
            ...
            <div class="wrapper-detail-event row">
                ...
                <div class="details-detail-event">
                    ...
                    <div class="date-input-detail-event" style="margin-top: 5px;">
                        <input type="text" class="form-control datepicker1" id="start_date" name="start_date" value="" />
                        <span class="line-date-detail-event"></span>
                        <input type="text" class="form-control datepicker1" id="end_date" name="end_date" value="" />
                    ...
                    <div class="time-input-detail-event">
                        ...
                        <input type="text" class="form-control time-pickable" id="start_time" name="start_time" value="" />
                        <span class="line-time-detail-event"></span>
                        <input type="text" class="form-control time-pickable" id="start_time" name="start_time" value="" />
                    </div> <br>
                    <div class="col-position-detail-event">Jln. Kuningan Jakarta Pusat
                        <!-- <input type="text" name="pos-detail-event" id="pos-edit" value="Jln. Kuningan Jakarta Pusat"> -->
                    </div> <br>
        ...
        <div class="description-detail-event">
            <div class="description-title-detail-event">
                <b>Description</b>
                <div class="border-description-detail-event">
        ...
        <div class="description-detail-event" style="margin-top: 20px">
            <div class="term-cond-title-detail-event">
                <b>Term and Condition</b>
                <div class="border-term-cond-detail-event">
                    <p>Detail Tiket:
                    </p><br>
